...
<div >
	...
	<div class="w3-container" style="text-align: center;">
		...
		<form action="modificaQ" method="Post">
			...
			<label for="quantita">Inserisci la quantità da rimuovere:</label>
			<input style="margin-top:0.5%;" type="number" placeholder="-0000" name="quantita" id="quantita" step="1" max="-1"><br>
