...
<!-- in caso di accesso manuale ad altre pagine -->
	...
	<form action="ModifichePrezzo.jsp">
...
<div >
	...
	<div class="w3-container" style="text-align: center;">
		...
		<form action="prezzo" method="Post">
			...
			<label for="prezzo">Inserisci Nuovo Prezzo:</label>
			<input style="margin-top:0.5%;" type="number" placeholder="0000" name="prezzo" id="prezzo" step="0.01" min="0.01"><br>
