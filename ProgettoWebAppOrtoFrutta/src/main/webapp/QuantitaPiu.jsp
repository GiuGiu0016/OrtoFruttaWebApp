...
<div >
	...
	<div class="w3-container" style="text-align: center;">
		...
		<form action="modificaQ" method="Post">
		
			<label for="iD">Inserisci iD-prodotto:</label>
			<input style="margin-top:0.5%;" type="number" placeholder="0000" name="iD" id="iD" min="1"><br>
			<label for="quantita">Inserisci la quantità da aggiungere:</label>
			<input style="margin-top:0.5%;" type="number" placeholder="0000" name="quantita" id="quantita" step="1" min="1"><br>
